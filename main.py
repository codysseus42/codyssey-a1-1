...
--ar 3:2  --raw  --stylize 120 """
    ...
    prompts  = [{"id":1, "title":"노코드 고양이 정보","content":CAT_ANALYZER,"category":"자동화","favorite":True,"cnt":0},{"id":2, "title":"고양이 사진 생성","content":MJ_CAT,"category":"이미지 생성","favorite":False,"cnt":0},{"id":3, "title":"가족사진생성","content":MJ_FAMILY,"category":"이미지 생성","favorite":True,"cnt":0}]
 #   prompts  = []
    while True:
        fn.show_menu()
